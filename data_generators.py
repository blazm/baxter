...
def random_data_generator(dir_with_src_images, base_image_filename, object_image_list, img_shape=(28, 28, 1), batch_size=32, mode=''):
    ...
    while True:
        ...
        for i in range(0, batch_size):
            ...
            for o in resized_objects:
                ...
                ho, wo, ch = o_rot.shape
                x = np.random.randint(low=0+wo, high=w-wo)
                #print((100 / ratio_h))
                y = np.random.randint(low=(100 / ratio_h)+ho, high=h-ho-(50 / ratio_h))
        ...
        #imsave("tmp/{}.png".format(label + "_out_generated_" + str(i)),  batch_outputs[0])
